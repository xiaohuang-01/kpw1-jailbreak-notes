...
本次只整理 KPW1 从故障确认到 5.4.4 降级、越狱原理分析、越狱包准备和验证设计的过程。

KOReader、KUAL、MRPI、SSH、USBNetwork、中文字体、拼音输入法、Z-Library 以及私人书库等内容属于其他 Kindle/其他阶段的折腾记录，与本次 KPW1 过程无关，已从本文和本次归档仓库中排除。
